...
const Point = () => {
    ...
    useEffect(() => {
      axios.get<Coords[]>(`https://nominatim.openstreetmap.org/?state=${routeParams.uf}&city=${routeParams.city}&format=json&limit=1`).then(response => {
    ...
    function handleNavigatorToBack(){
        navigation.goBack();
    }
    ...
    <SafeAreaView style={{flex:1}}>
        <View style={styles.container}> 
            <TouchableOpacity onPress={handleNavigatorToBack}> 
                ...
                initialRegion={{
                    ...
                    {points.map(point => (
                      ...
                      coordinate={{
                          ...
                          <Image style={styles.mapMarkerImage} source={require('../../assets/home-background.png')}></Image>
